export class Constants {
    ...
    public static STATES_AND_UT_LIST = [
        ...
        {value:'tamilNadu', display:'Tamil Nadu'},
        {value:'telangana', display:'Telangana'},
        {value:'tripura', display:'Tripura'},
        {value:'uttarPradesh', display:'Uttar Pradesh'},
        {value:'uttarakhand', display:'Uttarakhand'},
        {value:'westBengal', display:'West Bengal'},
        {value:'AndamanAndNicobar', display:'Andaman and Nicobar'},
        {value:'chandigarh', display:'Chandigarh'},
        {value:'damanAndDiu', display:'Daman and Diu'},
        {value:'dadarAndNagarHaveli', display:'Dadar and Nagar Haveli'},
        {value:'delhi', display:'Delhi'},
        {value:'jammuAndKashmir', display:'Jammu and Kashmir'},
